...
Effect = Union[
    ...
    DamageThoseDamagedThisGame,
    DamageRidersUntilEndOfTurn,
    DealDamage, Pump, SetBasePT, ChangeBasePT, GainAbilityText, GainKeyword, GainType, ChangeSupertype, ChangeLandType, LandTypeSwap, LoseKeyword, MoveCounter, PlayerGetsCounters, PutCounter, RemoveCounter,
    ...
    OwnershipExchangeUnlessPaid,
    RandomRevealOwnershipExchange,
    ExileTopOfLibrary, ExileEntireLibrary, PutExiledWithSource, ExileGraveyard, ExileCostSacrifices,
    ...
    DiscardRevealedMatchingUnlessPayLife,
    DiscardRevealedUnlessPayLife,
    Shuffle, ExtraTurn, ExtraLandPlays, CantPlayLands, EndTheTurn, ChooseNumber, ChooseColor, ChooseCardType, ChoosePlayerWhoCast, CountObjects, FlipCoin, WinGame, LoseGame, DrawGame, BecomeColor, BecomeCreature,
