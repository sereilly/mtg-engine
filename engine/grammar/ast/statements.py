...
Effect = Union[
    ...
    DamageThoseDamagedThisGame,
    DamageRidersUntilEndOfTurn,
    DealDamage, Pump, SetBasePT, ChangeBasePT, GainAbilityText, GainKeyword, GainType, BecomeAura, ChangeSupertype, ChangeLandType, LandTypeSwap, LoseKeyword, MoveCounter, PlayerGetsCounters, PutCounter, RemoveCounter,
