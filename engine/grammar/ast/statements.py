...
Effect = Union[
    ...
    DamageThoseDamagedThisGame,
    DamageRidersUntilEndOfTurn,
    DealDamage, Pump, SetBasePT, ChangeBasePT, GainAbilityText, GainKeyword, GainType, ChangeSupertype, ChangeLandType, LoseKeyword, MoveCounter, PlayerGetsCounters, PutCounter, RemoveCounter,
    ...
    DiscardRevealedMatchingUnlessPayLife,
    DiscardRevealedUnlessPayLife,
    Shuffle, ExtraTurn, EndTheTurn, ChooseNumber, ChooseColor, ChooseCardName, ChoosePlayerWhoCast, CountObjects, FlipCoin, WinGame, LoseGame, DrawGame, BecomeColor, BecomeCreature,
