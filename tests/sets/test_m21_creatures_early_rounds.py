...
and trigger narrowing. The rounds after those are in
``test_m21_creatures.py`` until it fills, then in
``test_m21_creatures_late_rounds.py`` — the same cut, made again at the
