...
**20 unclaimed sentence(s) across 16 supported card(s).**
...
| mixin text scan | 16 |
| cost_modifiers.py | 15 |
| untap_restrictions.py | 14 |
| activation_permissions.py | 10 |
| oracle.py (delayed trigger) | 7 |
| cast_timing.py (granted flash) | 5 |
| cast_timing.py (cleanup sacrifice rider) | 5 |
...
| x spend color (stack/activation) | 3 |
| revealed_hands.py | 3 |
