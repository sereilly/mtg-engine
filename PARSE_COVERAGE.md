...
| activation cost | 657 |
| trigger table | 459 |
| static-line table | 338 |
| keyword table | 303 |
| aura enchant noun (oracle_instructions attach) | 127 |
| card_hooks bespoke (name-keyed) | 96 |
| activation_restrictions.py | 60 |
| aura static (oracle_instructions/permanent_state) | 46 |
...
| cast_costs.py | 13 |
| untap_restrictions.py | 13 |
| cost_modifiers.py | 12 |
| activation_permissions.py | 8 |
