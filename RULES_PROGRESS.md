...
**346 / 612 tracked rules covered (56%)** — 1850 tests, 0 unannotated.
...
- [x] **601.2** To cast a spell is to take it from where it is (usually the hand), put it on the stack, and pay i... *(148 tests, subrules abcdefghi)*
...
- [x] **608.2** If the object that’s resolving is an instant spell, a sorcery spell, or an ability, its resolutio... *(49 tests, subrules bcdhn)*
