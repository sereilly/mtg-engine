...
**305 / 611 tracked rules covered (49%)** — 1401 tests, 0 unannotated.
...
- [x] **508.1** First, the active player declares attackers. This turn-based action doesn’t use the stack. To dec... *(15 tests, subrules abcdfk)*
