...
**343 / 612 tracked rules covered (56%)** — 1828 tests, 0 unannotated.
...
- [x] **601.2** To cast a spell is to take it from where it is (usually the hand), put it on the stack, and pay i... *(142 tests, subrules abcdefghi)*
