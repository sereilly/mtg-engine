...
- [x] **601.2** To cast a spell is to take it from where it is (usually the hand), put it on the stack, and pay i... *(149 tests, subrules abcdefghi)*
...
- [x] **608.2** If the object that’s resolving is an instant spell, a sorcery spell, or an ability, its resolutio... *(52 tests, subrules bcdhn)*
...
- [x] **611.2** A continuous effect may be generated by the resolution of a spell or ability. *(33 tests, subrules abc)*
