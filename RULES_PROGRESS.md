...
**351 / 612 tracked rules covered (57%)** — 1992 tests, 0 unannotated.
...
- [x] **601.2** To cast a spell is to take it from where it is (usually the hand), put it on the stack, and pay i... *(196 tests, subrules abcdefghi)*
