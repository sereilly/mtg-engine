...
**244 / 585 tracked rules covered (41%)** — 1097 tests, 0 unannotated.
...
- [x] **601.2** To cast a spell is to take it from where it is (usually the hand), put it on the stack, and pay i... *(73 tests, subrules abcdefghi)*
