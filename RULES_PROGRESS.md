...
**353 / 612 tracked rules covered (57%)** — 2006 tests, 0 unannotated.
...
- [x] **402.2** Each player has a maximum hand size, which is normally seven cards. A player may have any number ... *(6 tests)*
...
- [x] **508.1** First, the active player declares attackers. This turn-based action doesn’t use the stack. To dec... *(26 tests, subrules abcdfgk)*
...
- [x] **509.1** First, the defending player declares blockers. This turn-based action doesn’t use the stack. To d... *(59 tests, subrules abcdfghi)*
...
- [x] **601.2** To cast a spell is to take it from where it is (usually the hand), put it on the stack, and pay i... *(198 tests, subrules abcdefghi)*
...
- [x] **613.1** The values of an object’s characteristics are determined by starting with the actual object. For ... *(80 tests, subrules bcdefg)*
...
- [x] **704.5** The state-based actions are as follows: *(90 tests, subrules abcdefghijkmnpqrsy)*
