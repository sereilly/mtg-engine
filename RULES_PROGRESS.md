...
**357 / 612 tracked rules covered (58%)** — 2055 tests, 0 unannotated.
...
- [x] **601.2** To cast a spell is to take it from where it is (usually the hand), put it on the stack, and pay i... *(205 tests, subrules abcdefghi)*
