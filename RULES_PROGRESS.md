...
**350 / 612 tracked rules covered (57%)** — 1941 tests, 0 unannotated.
...
- [x] **601.2** To cast a spell is to take it from where it is (usually the hand), put it on the stack, and pay i... *(180 tests, subrules abcdefghi)*
...
- [x] **611.3** A continuous effect may be generated by the static ability of an object. *(50 tests, subrules abc)*
