...
- [x] **611.3** A continuous effect may be generated by the static ability of an object. *(15 tests, subrules abc)*
...
- [x] **613.1** The values of an object’s characteristics are determined by starting with the actual object. For ... *(26 tests, subrules bcdefg)*
...
- [x] **613.7** Within a layer or sublayer, determining which order effects are applied in is usually done using ... *(6 tests, subrules b)*
