...
**353 / 612 tracked rules covered (57%)** — 2022 tests, 0 unannotated.
...
- [x] **608.2** If the object that’s resolving is an instant spell, a sorcery spell, or an ability, its resolutio... *(59 tests, subrules bcdhn)*
...
- [x] **611.2** A continuous effect may be generated by the resolution of a spell or ability. *(37 tests, subrules abc)*
...
- [x] **613.1** The values of an object’s characteristics are determined by starting with the actual object. For ... *(83 tests, subrules bcdefg)*
