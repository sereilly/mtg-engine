...
**208 / 570 tracked rules covered (36%)** — 915 tests, 0 unannotated.
...
- [x] **611.3** A continuous effect may be generated by the static ability of an object. *(34 tests, subrules abc)*
...
- [x] **613.7** Within a layer or sublayer, determining which order effects are applied in is usually done using ... *(11 tests, subrules b)*
