...
**350 / 612 tracked rules covered (57%)** — 1973 tests, 0 unannotated.
...
- [x] **603.10** Normally, objects that exist immediately after an event are checked to see if the event matched a... *(8 tests, subrules a)*
