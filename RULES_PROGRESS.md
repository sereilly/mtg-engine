...
**337 / 612 tracked rules covered (55%)** — 1668 tests, 0 unannotated.
...
- [x] **509.1** First, the defending player declares blockers. This turn-based action doesn’t use the stack. To d... *(41 tests, subrules abcghi)*
