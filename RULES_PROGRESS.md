...
**348 / 612 tracked rules covered (56%)** — 1921 tests, 0 unannotated.
...
- [x] **601.2** To cast a spell is to take it from where it is (usually the hand), put it on the stack, and pay i... *(177 tests, subrules abcdefghi)*
...
- [x] **609.4** Some effects state that a player may do something “as though” some condition were true or a creat... *(13 tests, subrules b)*
...
- [x] **611.2** A continuous effect may be generated by the resolution of a spell or ability. *(34 tests, subrules abc)*
...
- [x] **702.26** Phasing *(11 tests, subrules adgm)*
